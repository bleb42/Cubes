...
public class CubeSpawner : MonoBehaviour
{
    ...
    public void ExplodeCube(Cube cube)
    {
        ...
        {
            cubes.Add(SpawnCube(cube.transform, cube.ChanceToDouble / 2, cube.Scale / 2));
        }

        _exploder.Explode(cubes, cube.transform);
    }

    private Cube SpawnCube(Transform transform, int changeToDouble = 100, float scale = 1)
    {
        ...
        cube.Init(this, changeToDouble, scale);
